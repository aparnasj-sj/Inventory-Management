...
<body>
    ...
    <!-- preloader area end 
    	<img src="image.jpg" alt="welcome " style="width:20%">-->
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            <li>
                                <a href="index.php" aria-expanded="true"><i class="ti-dashboard"></i><span><strong>DASBOARD</strong></span></a>
                            ...
                            <li class="active">
                                <a href="table.php" aria-expanded="true"><i class="fa fa-table"></i>
                                    <span ><strong>STOCK RECORDS</strong></span></a>
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span><strong>STOCK RECORDS</strong></span></li>
                            </ul>
                        </div>
                    </div>
...
<form method="POST" class="form-inline" action="additem.php">
  ...
  <div class="form-group">
        ...
        <input type="text" name="category" id="cat" min="1" max="">
    </div>
